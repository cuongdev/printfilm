...
const PromptEditor: React.FC<PromptEditorProps> = ({
  ...
  const resolvedLabel = label ?? t('promptEditor.defaultLabel');
  const resolvedPlaceholder = placeholder ?? t('promptEditor.defaultPlaceholder');
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        {!isEditing && (
          <button
            ...
            title={t('promptEditor.editButtonTitle')}
          >
