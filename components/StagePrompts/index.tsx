      ...
      <div className="border-b border-white/10 bg-slate-950/55 backdrop-blur-xl sticky top-0 z-10">
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold text-white mb-1">{t('header.title')}</h1>
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <option value="characters">{t('categories.characters')}</option>
              <option value="scenes">{t('categories.scenes')}</option>
              <option value="keyframes">{t('categories.keyframes')}</option>
            </select>
          </div>
        </div>
      </div>
          ...
          {hasNoData && (
            <div className="text-center py-16">
              <div className="text-zinc-600 mb-4">
                ...
                <p className="text-sm mt-2">{t('emptyState.detail')}</p>
              </div>
            </div>
          )}
        </div>
