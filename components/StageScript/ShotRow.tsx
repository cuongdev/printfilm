      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="pt-2">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">{t('shotRow.charactersLabel')}</span>
            <button
              ...
              title={t('shotRow.editCharactersTitle')}
            >
          ...
          {editingShotCharactersId === shot.id ? (
            <div className="space-y-3 p-3 bg-slate-950/55 border border-white/10 rounded-2xl">
              <div className="space-y-2">
                <div className="text-[10px] text-zinc-500 uppercase tracking-wider">{t('shotRow.currentCharactersLabel')}</div>
                      ...
                      return char ? (
                        <div key={cid} className="flex items-center gap-1 text-[10px] uppercase font-bold tracking-wider text-cyan-100/75 border border-cyan-200/15 px-2 py-1 rounded-full bg-cyan-300/10">
                          ...
                          <button
                            ...
                            title={t('shotRow.removeCharacterTitle')}
                          >
                            <X className="w-3 h-3" />
                          </button>
                        </div>
              ...
              <div className="space-y-2">
                <div className="text-[10px] text-zinc-500 uppercase tracking-wider">{t('shotRow.addCharactersLabel')}</div>
                <div className="flex flex-wrap gap-2">
                  {scriptData?.characters
                    ...
                    .map(char => (
                      <button
                        ...
                        title={t('shotRow.addCharactersLabel')}
                      >
        ...
        <div className="xl:hidden pt-4 border-t border-white/10">
          <div className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest mb-2 flex items-center gap-2 justify-between">
            <span className="flex items-center gap-2">
              <Aperture className="w-3 h-3" /> {t('shotRow.visualPromptLabel')}
            </span>
            {editingShotId !== shot.id && (
              <button
                ...
                title={t('shotRow.editVisualPromptTitle')}
              >
